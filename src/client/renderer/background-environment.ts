...
export class BackgroundEnvironment {
  ...
  private _getMaterial(): ShaderMaterial {
    let material = this._materialMap.get(this.parameters.backgroundType);
    if (material) {
      return material;
    }
    ...
    this._materialMap.set(this.parameters.backgroundType, material);
    return material;
  }
}

export class BackgroundEnvironmentGUI {
  private _backgroundEnvironment: BackgroundEnvironment;
  private _backgroundTypeController?: GUIController;

  constructor(backgroundEnvironment: BackgroundEnvironment) {
    this._backgroundEnvironment = backgroundEnvironment;
  }

  public hideBackground(): void {
    this._backgroundTypeController?.setValue('None');
    this._backgroundTypeController?.updateDisplay();
  }
  ...
  public addGUI(
    ...
    backgroundTypes.forEach((value, key) => {
      ...
      if (this._backgroundEnvironment.parameters.backgroundType === value) {
