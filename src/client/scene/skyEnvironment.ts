...
export class SkyEnvironment {
  ...
  public updateSky() {
    ...
    const sunPosition = viewSpacePositionFromUV(
...
export class SkyEnvironmentGUI {
  ...
  public addGUI(
    gui: GUI,
    updateCallback?: (skyEnvironment: SkyEnvironment) => void
  ): void {
    this.showSkyController = gui
      .add<any>(this.skyEnvironment.parameters, 'visible')
      .onChange(() => {
