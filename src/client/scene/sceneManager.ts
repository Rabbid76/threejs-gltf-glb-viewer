...
import { QualityLevel, SceneRenderer, SceneRendererParameters } from '../renderer/scene-renderer'
...
export class SceneManager {
    ...
    private changeEnvironmentMapIntensity(
    ...
    public prepareRender(mousePosition: Vector2): void {
        ...
        if (this.updateEnvironmentIntensity) {
            ...
            //this.changeEnvironmentMapIntensity(this.scene, this.sceneRenderer.environmentLights ? 1 : 1);
        }
